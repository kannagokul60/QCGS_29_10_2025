...
export function ExamplePanel({ context, rosUrl }: ExamplePanelProps): ReactElement {
  ...
  // ---------------------- ROS CONNECTION --------------------------
useEffect(() => {
  if (!rosUrl) return; // only connect when rosUrl is available

  const rosConnection = new ROSLIB.Ros({
    url: rosUrl, // dynamic value
  });
